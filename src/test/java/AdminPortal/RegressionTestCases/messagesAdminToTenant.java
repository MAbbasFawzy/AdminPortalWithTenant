...
public class messagesAdminToTenant {
	...
	public void broadcastDataAddition() throws InterruptedException {
		...
		Thread.sleep(4000);
		WebElement recipientList = driver.findElement(By.xpath("//div[@class='p-multiselect p-component p-inputwrapper p-multiselect-chip w-full h-10 flex items-center']//div[@class='p-multiselect-label-container']"));
        recipientList.click();
		
		WebElement search = driver.findElement(By.xpath("//input[@type='text' and @class='p-multiselect-filter p-inputtext p-component' and @role='searchbox']"));
	...
	@Test (priority = 3)
	public void checkMessageTenantPortal() {
		
		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
		WebElement messageIcon = driver.findElement(By.xpath("//nav[@class='fixed z-10 top-0 right-0 w-full border border-b shadow-xl bg-[var(--c1)] hidden sm:block print:!hidden']//a[1]//p[1]//*[name()='svg']"));
		messageIcon.click();
		
		WebElement messageInbox = driver.findElement(By.xpath("//div[@class='text-xs mb-1 flex gap-2']"));
		messageInbox.click();
		
		WebElement messageBodyDetails = driver.findElement(By.xpath("//p[normalize-space()='Welcome to Yarn.']"));
		Assert.assertEquals(messageBodyDetails.getText(), messagebody);
	}
